// assets.js — 14 modèles GLB (14 interactifs + décor non-interactif)
// Les 4 objets géométriques supplémentaires sont créés dans main.js.
export const sceneConfig = {
    models: [
        {
            name: 'decor',
            path: 'objets/decor/decor.glb',
            pos: [0, -2, 5.2],
            scale: [2.3, 2, 2],
            rotY: 0,
            interact: false,
        ...
        {
            name: 'arcade',
            path: 'objets/decor/rusty_japanese_arcade.glb',
            pos: [5.2, -2, 1.5],
            scale: [0.65, 0.7, 0.8],
            rotY: -0.9,
            interact: false,
        ...
        },
        {
            ...
            // ⚠️  Déposez le fichier akira_bike.glb dans public/objets/
            name: 'akira_bike',
            path: 'objets/akira_bike.glb',
            pos: [0.2, 0.85, 3.1],
            scale: [0.15, 0.15, 0.15],
            rotY: 0,
            interact: true
        ...
        {
            // Œil cybernétique · Ghost in the Shell
            // ⚠️  Déposez le fichier ghost_shell_eye.glb dans public/objets/
            name: 'ghost_shell_eye',
            path: 'objets/ghost_shell_eye.glb',
            pos: [-3.2, 1.6, 0.3],
            scale: [0.15, 0.15, 0.15],
            rotY: 0,
            interact: true
